			...
			>
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						<Text style={styles.modalText}>{selectedCommunity?.joinPrivacy === 'private' ? 'Request to join' : 'Join'} {selectedCommunity?.name}?</Text>
						<View style={styles.buttonContainer}>
							<Button title={selectedCommunity?.joinPrivacy === 'private' ? 'Request to join' : 'Join'} onPress={handleJoin} />
