...
import { View, Text, ScrollView, StyleSheet, Modal, Button, TextInput, Platform, Pressable } from 'react-native';
...
const Reminders = () => {
    ...
    const handleAddReminder = () => {
        ...
        // Reset the form
        setNewReminder({id: null, description: '', time: '', date: '', frequency: 'Daily'});
    ...
    const onChangeTime = (event, selectedDate) => {
        ...
        let formattedTime = `${hours % 12 || 12}:${minutes < 10 ? '0' + minutes : minutes} ${hours < 12 ? 'AM' : 'PM'}`;
            ...
            <ScrollView style={styles.scrollViewContainer}>
                {reminders.map((reminder) => (
                    <View key={reminder.id} style={styles.reminderItem}>
                        ...
                        <Text style={styles.reminderInfoText}>Time: {reminder.time}</Text>
                        <Text style={styles.reminderInfoText}>Frequency: {reminder.frequency}</Text>
                    </View>
                ))}
            </ScrollView>
