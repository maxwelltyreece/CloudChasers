    ...
    <View style={styles.progressBarComponentContainer}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.goalInfoSection}>
          <Text style={styles.currentGoalTitle}>{selectedGoal.description} {selectedGoal.frequency}</Text>
      ...
      <Text style={styles.currentProgressBarText}>{current}/{selectedGoal.description}</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable style={styles.goalItem} onPress={() => selectGoal(item)}>
                <Text style={styles.goalItemText}>{item.description} {item.frequency}</Text>
              </Pressable>
            )}
